    ...
    <ul>
      <li class="active"><a href="index.html">宝宝起名</a>
        <ul>
          ...
          <li><a href="/name/list.html">出生命运</a></li>
          <li><a href="/name/AllName.do">名字大全</a></li>

          
          <li><a href="/name/SourceList.do">姓氏起源</a></li>
          <li><a href="/name/BoyName.do">男孩常用名大全</a></li>
          <li><a href="/name/GirlName.do">女孩常用名大全</a></li>
          <li class="last"><a href="DatetTime.html">万年历</a></li>
        </ul>
      </li>
          ...
          <div class="container">
             <div class="slider">
              <div class="callbacks_container">
                ...
                <li>
                  <div class="caption">
                  <h2 align="center">姓名介绍</h2>
                  <p style="margin-left: 15px;"> 姓名在上个时代中是由姓氏和名字号组成，在现代我们大部分都是由姓名组成，有很大一部分文化传承就这样给流溢了，中国几千年的名文化本来就有一个共同的起名特点：在我们以名文化为背景的起名是比较稳定，因为中华民族文化传承渊博，又是一个文化大国。我们的名文化不会被外族文化洗礼，虽然今天的姓名文化与传统的名文化存在很大的差异，在很多情况下文化也会随历史的原因而改变。当代是中国文化在崛起的时期，因为姓和名在人们纷乱时期都还没有固定，现代名文化处于萌芽状态，所以现代的姓和名都比较乱。基本上是姓名，根本就不谈姓氏了，一个人就只有一个姓名，根本就没有字辈、别号之类的名称了，在80后我们看到了大部分是两个字为姓名的人，上九十年代就出现很多四个字起姓名的人，今天就特别注重三个字的姓名。在现代姓名的文化中是极其地纷乱。。</p>
                  </div>
                </li>
      ...
      <ul>
       ...
       <!--  
        ...
        <li>
          ...
          <p class="readmore"><a href="#">了解行业新闻 &raquo;</a></p>
        </li>
        <li class="last">
          <h2 align="center" >团队 . 精英</h2>
          ...
          <p class="readmore"><a href="#">了解我们团队 &raquo;</a></p>
        </li>
          --> 
    ...
    <div id="hpage">
      <ul>
        <li>
          ...
          <p class="readmore"><a href="#">走进企业风采 &raquo;</a></p>
        </li>
        <li>
          <h2>企业名录</h2>
          <div class="imgholder"><a href="#"><img src="/module/name/images/6.jpg" alt="" height="60px" /></a></div>
