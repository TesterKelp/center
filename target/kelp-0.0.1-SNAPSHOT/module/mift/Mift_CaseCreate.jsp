...
<body class="gray-bg">
									...
									<div class="col-sm-9">
										<form role="form" method="get" class="form-horizontal">
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" class="form-control" id="ifaddress">
												</div>
											...
											<div class="form-group">
												<label class="col-sm-1 control-label">URL参数:</label>
	...
	<script src="/module/mift/js/Mift_CaseCreate.js"></script>
	<!-- 自定义js -->
    ...
    $(function(){
    	...
    	//	className: ["form-control", "form-control"],//不用我解释了吧
    	     size: 20,
    		toplimit:8,//可以添加组数上限（默认是0，表示无上限），它是总管，so，name相当于小组组长
    ...
    **///欢迎来到站长特效网，我们 的网址是www.zzjs.net，很好记，zz站长，js就是js特效，本站收集大量高质量js代码，还有许多广告代码下载。
    ...
    document.getElementById("url").innerHTML = a  +"  <input name='password' size='50' />  <input name='password' size='25'  />   <a href ='#'  onclick='AddLine()' >add</a>  <a href ='#'  onclick='DelLine(this)' >del</a> "; 
    }
   ...
   //     	}
    ...
    function SaveIfCase(){
    	...
    	$.ajax({
    		type : "POST",
    		url : "/mift/SaveIfCase.do",
    		data: {"els":_list,"elv":_val,"casename": casename,"casedesc":casedesc,"type":type,"header":header,"Interfaceid":Interfaceid},
    		async : false,
    		dataType : "json",
    		 traditional: true,
