...
<body class="gray-bg">
	<div id="defect">
		<div class="defect_top">
			...
			<auto:LoginInfo></auto:LoginInfo>  |  Kelp使用交流群：513299582
		</div>
	</div>
	<br>
	<br>
	...
	<div class="wrapper wrapper-content animated fadeInRight">
		...
		<div class="ibox float-e-margins">
			<div class="ibox-content">
					...
					<br>
						<label class="col-sm-1 control-label">执行计划名称:</label>
						<div class="col-sm-2">
						...
						<div class="example-wrap">
							<div class="example">
								...
								<table     class="table table-bordered" id="myTable">
                                    ...
                                    <td style="text-align: left; vertical-align: middle; width: 30%; "><a href="#" onclick="SetRunnerPlanDefault(${a.libid })">切换到该计划 </a> <a href="#"  onclick="ShowAddCase(${a.libid })" >导入执行用例(${a.casenumber }) </a> 
                                      </td>
				...
				<div class="col-sm-4 col-sm-offset-2">
					<button type="input" class="btn btn-primary"
						onclick="AddCaseToLib()">导入</button>
						 ...
						 <input class="form-control" type="hidden" id="libid">
				</div>
			</div>
		</div>
	</div>
