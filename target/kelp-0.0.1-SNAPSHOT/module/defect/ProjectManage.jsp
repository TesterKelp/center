...
<div class="fht-cell" style="width: 177px;">项目名称</div>
</th>

<th style="text-align: center; vertical-align: middle; width: 10%; " data-field="operationid" tabindex="0">
<div class="th-inner ">项目操作</div>
<div class="fht-cell" style="width: 177px;"></div>
</th>
...
<td style="text-align: center; vertical-align: middle; width: 10%; ">    <!--   <a href="Operation.do?projectid=${a.projectid }" >    定义数据项</a>  -->      <a href="AjaxOperation.do?projectid=${a.projectid }" >  定义数据项</a>     </td>
</tr>
...
function  CreateProject(){
	...
	<!-- <script src="js/OperationManage.js"></script> -->
