					...
					<div class="col-sm-12">
						...
						<div class="example-wrap">
							<div class="example">
									...
									<tbody>
										...
										<c:forEach items="${bodyList}" var="a">
											...
											<tr>
												...
												<td><textarea aria-required="true" required=""
														class="form-control" name="comment" id="result"> ${a.result}  </textarea></td>
												<td><a style="text-decoration: none" class="ml-5"
													onClick="AddS(this)" href="javascript:;" title="编辑"> ++</a>
								...
								<button type="input" class="btn btn-primary" onclick="addCase()">编辑</button>
