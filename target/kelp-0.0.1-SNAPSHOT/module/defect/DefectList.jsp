...
<body class="gray-bg">
						...
						<div class="example-wrap">
							<div class="example">
								...
								<!-- 	<a href="DefectCreate.jsp">
									...
									| <a href="#" onclick="Search()">我关闭的</a> 	| --><a href="#" onclick="ChangeProject()">切换项目</a> |  当前项目：${projectname}
 ...
 <li><a href="mail_compose.html"><i class="fa fa-tag"></i>朋友</a></li>
	...
	<Br> 
	 <button class="btn btn-primary dim btn-large-dim" type="button">智慧城市</button>
	 <Br>
	--> 
