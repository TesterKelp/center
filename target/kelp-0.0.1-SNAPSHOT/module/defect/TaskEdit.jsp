...
${cumhtml}
											...
											<div class="form-group">
												...
												<div class="col-sm-7">
													<input type="text" class="form-control" id="title"  value="${taskname}"  name="title">
												</div>
												<div class="col-sm-4">
											...
											<div class="form-group">
												...
												<div class="col-sm-11">
													<script id="editor" type="text/plain" style="width: 100%; height: 530px;">${taskcontent}</script>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input name="hi" type="button" onclick="EditTask()" value="编辑任务" /> <input name="hi" type="button"	onclick="javascript: self.location='Task.do';" value="返回" />
														<input type="text" class="form-control" name="taskid" value="${taskid}" id="taskid">
