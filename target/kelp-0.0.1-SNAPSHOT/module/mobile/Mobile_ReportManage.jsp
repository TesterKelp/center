...
<div class="th-inner ">报告ID</div><div class="fht-cell" style="width: 30px;"></div></th>
		
<th style="text-align: center; vertical-align: middle; width: 10%; " data-field="operationid" tabindex="0">
<div class="th-inner "></div><div class="fht-cell" style="width: 177px;">任务名称</div></th>

<th style="text-align: center; vertical-align: middle; width: 10%; " data-field="operationid" tabindex="0">
<div class="th-inner ">操作</div><div class="fht-cell" style="width: 100px;"></div></th>
...
<tr data-index="4">
<td style="text-align: center; vertical-align: middle; width: 10%; ">${a.reportid}</td>
<td style="text-align: left; vertical-align: middle; width: 10%; "><a href="/systemtest/Web_ReportDetail.do?reportid=${a.reportid}">${a.taskname}</a></td>
<td style="text-align: center; vertical-align: middle; width: 10%; "><a href="/systemtest/Web_ReportDetail.do?reportid=${a.reportid}"> 查看</a></td>
