...
<input type="text" id="testtype"    value="${testtype}" class="form-control">
		<!-- Panel Other -->
...
var url = "Web_ReportManageJson.do?testtype="+testtype;
//alert(url);
var $table = $('#t8');
$table.bootstrapTable({
	...
	columns : [
			...
			formatter : function(value, row, index) {
						...
						var f = '<a href="/systemtest/Web_ReportDetail.do?reportid='+row.reportid+'"> [查看]</a>' ;
