...
<body>
	...
	<div id="header">
		<div class="container">
			...
			<nav id="nav">
			<ul>
				<li class="active"><a href="Blog.do?userid=${userid}">首页</a></li>
		...
		<div class="container">
			<div class="row">
				...
				<c:forEach items="${topiclist}" var="t">
					<div class="4u">
						<h2 align="center">
							<a href="/module/share/topiccover.do?topicid= ${t.topicid} ">
								${t.topicname} </a>
						</h2>
 ...
 Sidebar   end  -->
					...
					<div class="4u">
						...
						<ul class="default">
							<li class="box">${ status.index + 1} . <a
								href="Content.do?userid=${userid}&&blogid=${p.articleid}">${p.articletitle}
							</a></li>
						</ul>
						</section>
					</div>
	...
	<!-- Copyright -->
	<div id="copyright">
		<div class="container">欢迎光临${username}的测试博客！</div>
	</div>
