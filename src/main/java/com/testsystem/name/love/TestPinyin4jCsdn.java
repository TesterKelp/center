...
public class TestPinyin4jCsdn {
    ...
    public static void main(String[] args) {
        ...
        String pinYin1 = getAllPinyin("孟祥彬");
        
        
        String firstPinYin1 = getFirstPinYin("孙晓芳");
        
        System.out.println("孟祥彬："+pinYin1);
        System.out.println("孙晓芳首字母："+firstPinYin1);
