				...
				<div class="form-horizontal col-sm-12">
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								...
								<input type="hidden" class="form-control" id="environmentid" placeholder="所属服务器id">
						...
						<div class="example-wrap">
							<div class="example">
								...
								<table class="table table-bordered" id="RequestHeader">
									<thead>
										<tr>
											<th width="150px">Request header</th>
								...
								<table class="table table-bordered" id="ResponseHeader">
									<thead>
										<tr>
											<th width="150px">Response header</th>
											<th width="300px">参数名</th>
											<th width="130px">是否必填</th>
											<th >描述</th>
										</tr>
							...
							<div class="form-group"><script id="editor" type="text/plain" style="width: 100%; height: 300px;">接口描述:</script></div>

						  <div class="form-group">
								<label class="col-sm-4 control-label"> </label>
								<div class="col-sm-6">
									<div class="btn btn-primary"><a href="#" onclick="AddFace()">保存</a>  </div>
									<div class="btn btn-primary"> <a href="#" onclick="CreateWiftInterface()">new保存</a></div>
								</div>
								<br class="clear" />
								<br>
							</div>
							...
							<div class="form-group">
                                	...
                                	<div id="ControlsRow">
											<input type="Button" value="mock模拟json" onclick="demojson()" />
								...
								<textarea id="RawJson"  style="height: 300px;width:100%"> </textarea>
