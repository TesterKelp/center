				...
				<div class="form-horizontal col-sm-10">
					<div class="form-group">
						...
						<div class="col-sm-1">
							...
							<input class="form-control" type="text" id="testtype"  value="3"  >
						</div>
...
<div class="th-inner ">任务ID</div><div class="fht-cell" ></div></th>
		
<th style="text-align: center; vertical-align: middle; width: 10%; " data-field="operationid" tabindex="0">
<div class="th-inner "></div><div class="fht-cell" >任务名称</div></th>

<th style="text-align: center; vertical-align: middle; width: 10%; " data-field="operationid" tabindex="0">
<div class="th-inner ">执行机</div><div class="fht-cell" ></div></th>

<th style="text-align: center; vertical-align: middle; width: 10%; " data-field="operationid" tabindex="0">
<div class="th-inner ">创建者</div><div class="fht-cell" ></div></th>


<th style="text-align: center; vertical-align: middle; width: 15%; " data-field="operationid" tabindex="0">
<div class="th-inner ">创建时间</div><div class="fht-cell" ></div></th>

<th style="text-align: center; vertical-align: middle; width: 15%; " data-field="operationid" tabindex="0">
<div class="th-inner ">运行时间</div><div class="fht-cell" ></div></th>

<th style="text-align: center; vertical-align: middle; width: 10%; " data-field="operationid" tabindex="0">
<div class="th-inner ">用例管理</div><div class="fht-cell" ></div></th>

<th style="text-align: center; vertical-align: middle; width: 10%; " data-field="operationid" tabindex="0">
<div class="th-inner ">执行状态</div><div class="fht-cell" ></div></th>

<th style="text-align: center; vertical-align: middle; width: 10%; " data-field="operationid" tabindex="0">
<div class="th-inner ">操作</div><div class="fht-cell" ></div></th>
<tr>							
...
<input type="text" onBlur="setMac(${a.taskid},this)"  value="${a.clicentaddress}" placeholder=" 任务名称" style="width:180px" class="input-text">  </td>
<td style="text-align: center; vertical-align: middle; width: 10%; ">${a.realname} </td>
<td style="text-align: left; vertical-align: middle; width: 15%; ">${a.createtime}</td>
<td style="text-align: center; vertical-align: middle; width: 15%; ">${a.runnertime}</td>
<td style="text-align: center; vertical-align: middle; width: 10%; "> <A href="/wift/Wift_TaskDetail.do?taskid=${a.taskid}">用例管理 </A></td>
...
function addTask(){
	...
	$.ajax({
		type : "POST",
		url : "/systemtest/AddTask.do",
		data: {taskname:task,rtime:rtime,testtype:testtype},
		async : false,
		dataType : "text",
		success : function(data) {
			alert("ok");
