...
<link href="../../test/json/s.css" type="text/css" rel="stylesheet"></link>
</head>
									...
									<div class="col-sm-12">
										<form role="form" method="get" class="form-horizontal">
											<div class="form-group">
												...
												<select class="form-control" id="module" onchange='getInterface()'>
												...
												<div class="col-sm-2">
													<select class="form-control" id="type" name="type">
														...
														<option value="JSONPOST" <c:if test="${requesttype=='JSONPOST'}"> selected = "selected" </c:if>>JSONPOST</option>
													</select>
												</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" class="form-control"  value="${environmentname}"    id="environmen">
												</div>
											</div>
...
<!--  
	...
	<textarea aria-required="true" required="" class="form-control" name="comment" id="ccomment"></textarea>
                            ...
                            <div id="tab-5" class="tab-pane">
                             <textarea aria-required="true" required=""
														class="form-control" name="comment" id="RawJson"></textarea>
                            </div>
...
<!-- 	<script src="/module/wift/js/facecreate.js"></script>-->
	<script src="/module/wift/js/Wift_CreateCaseLoadPage.js"></script>
	<!-- 自定义js -->
