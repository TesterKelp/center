...
<div class="col-sm-12">
			<div class="form-horizontal col-sm-4">
				<div class="ibox-content">
					...
					<a href="S_PageHtml.do">生成分类内容页</a> <Br> <a href="makeCate.do">生成分类页</a>
					<Br> <a href="makeContent.do">生成内容页</a> <Br> <Br> <a
						href="makeindex.do">生成首页</a> <Br> <a href="makeTopic.do">专题首页</a>
					<Br> <a href="makeCover.do">专题封面</a> <Br> ${info}
				</div>
			...
			<div class="col-sm-8">
				<div class="ibox-content">当前操作： 正在生成：
  ...
  <script type="text/javascript">
    var webSocket =
      new WebSocket('ws://192.168.1.102:8080/ws');
