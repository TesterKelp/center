	...
	<div class="wrapper wrapper-content animated fadeInRight">
		...
		<div class="ibox float-e-margins">
			...
			<div class="ibox-content">
				<!--    
<div class="col-sm-1">
     <div class="btn btn-primary" ><a href="FaceCreate.html">创建接口</a> </div>
     </div>
                   -->
				<div class="col-sm-2">
			...
			<div class="col-sm-1">
					...
					<div class="btn btn-primary" >
						<a href="/module/mift/Mift_InterfaceCreate.jsp">创建接口</a>  
					</div>
	...
	<script src="/module/mift/js/miftInterface.js"></script>
	<!-- Peity      -->
