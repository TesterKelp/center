...
//      url: "../../test/js/demo/bootstrap_table_test.json",
      url: "/module/defect/jsGetLibCase.do", 
      search: true,
      pagination: true,
      pageSize: 20,
      showRefresh: true,
        ...
        title: '用例标题',
          ...
          valign: 'middle',
           ...
           formatter:function(value,row,index){  
               ...
               var a = "<a href=CaseRunner.do?caseid="+row.caseid+" > "+ row.casename+'</a> ';
...
//                },
                ...
                
            {
               ...
               // 	var  b="<a href='DefectLoaderEditPage.do?bugid="+row.bugid+"' >   <font color='#F00'>删除  </font></a> ";
                	
                	var  c="<a href=CaseRunner.do?caseid="+row.caseid+" >   <font color='#F00'>运行  </font></a> ";
                	
//                	var  d="<a href='DefectLoaderEditPage.do?bugid="+row.bugid+"' >   <font color='#F00'>明细  </font></a> ";
                	
//                	var  a="<a href='DefectLoaderEditPage.do?bugid="+row.bugid+"' >   <font color='#F00'>编辑  </font></a> ";
                	
//                	var  e="<a href='DefectLoaderEditPage.do?bugid="+row.bugid+"' >   <font color='#F00'>生成bug </font></a> ";
                	var result =c ;
                	return  result ;
                     } 
            }
