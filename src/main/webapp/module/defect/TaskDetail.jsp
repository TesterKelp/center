...
<tr height="25px"><td>	状态 ：</td><td><c:if test="${tstatus==1}">新建</c:if><c:if test="${tstatus==2}">已解决</c:if><c:if test="${tstatus==3}">已关闭</c:if> </td></tr>
<tr height="25px"><td>创建时间：</td><td>${ctime} </td></tr>

<auto:TaskTags   taskid="${taskid}"></auto:TaskTags>
