	...
	<div class="wrapper wrapper-content animated fadeInRight">
		...
		<div class="ibox float-e-margins">
			...
			<div class="ibox-content">
				...
				<div class="btn btn-primary" id="test1">创建操作</div>   	<input type="text" class="form-control" id="projectid" value="0">
...
-->
	...
	<script src="js/OperationManageTaskAndCase1.js" charset="utf-8"></script>
