...
<body class="gray-bg">
	...
	<div class="wrapper wrapper-content animated fadeInRight">
		...
		<div class="ibox float-e-margins">
			<div class="ibox-content" style="min-height: 800px;  margin: 0 200px 0 200px">
							...
							<div class="example-wrap margin-sm-0">
								...
								<div class="example">
									<table data-toggle="table" data-row-style="rowStyle"
										...
										<thead>
											<tr>
												<th data-field="Tid">缺陷ID</th>
												<th data-field="Score">缺陷标题</th>
											</tr>
										</thead>
										<c:forEach items="${defectList}" var="d" varStatus="status">
											<tr data-index="${status.index%5+1}">
												<td
													style="text-align: center; vertical-align: middle; width: 2%;">
													${d.bugid}</td>
												<td
													style="text-align: center; vertical-align: middle; width: 98%;"><a
													href="DefectDetail.do?bugid=639"> ${d.bugtitle}</a></td>
											</tr>
										</c:forEach>
									</table>
								</div>
							...
							<div class="example-wrap margin-sm-0">
								...
								<div class="example">
									<table data-toggle="table" data-row-style="rowStyle"
										...
										<thead>
											<tr>
												<th data-field="Tid">任务ID</th>
												<th data-field="Score">任务标题</th>
											</tr>
										</thead>
										<c:forEach items="${taskList}" var="t" varStatus="status">
											<tr data-index="${status.index%5+1}">
												<td
													style="text-align: center; vertical-align: middle; width: 2%;">
													${t.taskid}</td>
												<td
													style="text-align: center; vertical-align: middle; width: 98%;">
													<a href="DefectDetail.do?bugid=639">${t.taskname}</a>
												</td>
											</tr>
										</c:forEach>
									</table>
										...
										<c:forEach items="${taskList}" var="t" varStatus="status">
											<tr data-index="${status.index%5+1}">
												<td
													...
													${t.taskid}</td>
												<td
													style="text-align: left; vertical-align: middle; width: 33%;"><a
													href="DefectDetail.do?bugid=639">${t.taskname}</a></td>
												<td
