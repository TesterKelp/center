...
<body class="gray-bg">
		...
		<div class="ibox float-e-margins">
			<div class="ibox-title">
				...
				<div class="ibox-tools">
				 	...
				 	<input class="form-control" type='hidden' id="vauleWidgetId">
				 	<input class="form-control" type='hidden' id="vauleWidgetType">
				</div>
			</div>
			<div class="ibox-content">

				<div class="btn btn-primary" id="test1">添加组件</div>  
	...
	<input type="text" class="form-control" id="schemeId" value="${schemeId}">
				<div class="form-group">
					<label class="col-sm-4 control-label">操作名称：</label>
					<div class="col-sm-5">
						<input type="text" class="form-control" id="widgetChinaName">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" id="widgetEnglishName">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<div class="col-sm-4 col-sm-offset-2">
						<button type="submit" class="btn btn-primary"
							onclick="saveWidgetValue()">设置默认值</button>
					</div>
				</div>
		</div>
...
-->
	...
	<div id="ShowSetSelectDefault" style="display: none" > <!-- style="display: none" -->
		<br>
		<div class="form-group">
			<div class="col-sm-10">
		...
		<div class="col-sm-6 b-r">
			<div class="form-horizontal">
				...
				<div class="form-group">
					<div class="col-sm-4 col-sm-offset-2">
						<button type="submit" class="btn btn-primary"
							onclick="saveWidgetValue()">添加选项</button>
					</div>
				</div>
			</div>
		</div>
	...
	<script src="js/SchemeWidget.js" charset="utf-8"></script>
