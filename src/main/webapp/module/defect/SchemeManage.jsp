			...
			<div class="ibox-content" >
				...
				<div class="form-horizontal col-sm-10">
					<div class="form-group">
						<div class="col-sm-2">
							<input class="form-control" type="text" id="schemeName"  placeholder="方案名称"  >
						</div>
						<div class="col-sm-2">
						<select class="form-control" id="schemeType" >
						   <option value="" disabled selected>选择方案类型</option>  
							<option value="1">缺陷</option>
							<option value="3">用例</option>
						</select>
					</div>
						<div class="col-sm-1">
							<div class="btn btn-primary"     onclick="addSchmem()">创建方案</div>
						</div>
					</div>
</div>
				...
				<div class="row row-lg">
					<div class="col-sm-12">
						...
						<div class="example-wrap">
							<div class="example">
								<table id="scheme" data-mobile-responsive="true" data-height="500">
								</table>
							</div>
						</div>
...
function  CreateProject(){
	...
	<script src="js/SchemeManage.js"></script> 
