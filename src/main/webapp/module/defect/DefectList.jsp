...
<body class="gray-bg">
						...
						<div class="example-wrap">
							<div class="example">
								<div class="btn-group hidden-xs" id="exampleTableEventsToolbar"
									role="group">
									<shiro:hasPermission name="user:cbug"></shiro:hasPermission>
								<!-- 	<a href="DefectCreate.jsp">
										<button type="button" class="btn btn-outline btn-default">
											<i class="glyphicon glyphicon-plus" aria-hidden="true"></i>
										</button>
									</a>   --> <a href="DefectCreate.jsp" >创建缺陷</a> | <!--  <a href="#" onclick="Search()">需要我出马</a> | <a href="#"
										onclick="Search()">我创建的</a> | <a href="#" onclick="Search()">我解决的</a>
									| <a href="#" onclick="Search()">我关闭的</a> 	| <a href="#" onclick="ChangeProject()">切换项目</a> |-->  当前项目：<auto:ProjectName></auto:ProjectName>    
	...
	<div id="ShowAssigned" style="display: none">
		<div class="ibox-content">
			<form class="form-horizontal" method="get">
				<div class="form-group">
					<label class="col-sm-3 control-label">坐镇专家：</label>
					<div class="col-sm-6">
	...
	<div id="ShowRefuse" style="display: none">
		<div class="ibox-content">
			...
			<div class="form-group">
				<div class="col-sm-4 col-sm-offset-2">
					<button type="input" class="btn btn-primary"
						onclick="DefectRefuse()">拒绝</button>
				</div>
			</div>
		</div>
	</div>
...
//      url: "../../test/js/demo/bootstrap_table_test.json",
      url: "/module/defect/AssignedMeDefect.do", 
      search: true,
      pagination: true,
      pageSize: 20,
      showRefresh: true,
