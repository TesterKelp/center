					...
					<div class="ibox-content">
						<div class="row">
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control m-b" name="account" id="item"  >
                                         <c:forEach items="${tlst}" var="a" varStatus="status">
                                         <c:if test="${a.item_id == topic.itemid }" >
                                          <option value="${a.item_id}" selected >${a.item_name}</option> 
                                         </c:if>
                                         <c:if test="${a.item_id != topic.itemid }" >
						...
						<div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control m-b" name="account" id="template"  >
                                         <c:forEach items="${ltlst}" var="a" varStatus="status">
                                         
                                         <c:if test="${(status.index+1) == topic.skin }" >
                                          <option value="${status.index+1}" selected >皮肤${status.index+1}</option> 
                                         </c:if>
                                         
                                         <c:if test="${(status.index+1) != topic.skin }" >
                                          <option value="${status.index+1}"  >皮肤${status.index+1}</option> 
                                         </c:if>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input id="topicname" name="topicname" class="form-control"
												type="text" value="${topic.topicname}" aria-required="true"
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<textarea id="topicintro" class="form-control"
												aria-required="true" required="" name="topicintro"> ${topic.topicintro}</textarea>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input id="topicimage" name="topicimage" class="form-control"
												value="${topic.topicimage}" type="hidden"> <input
												name="imgAddress" type="hidden"> <input
												name="topicid" id="topicid" value="${topic.topicid}" type="hidden">
										...
										<img  src="${topic.topicimage}" style="width:100px;height:100px"/>
