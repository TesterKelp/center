...
//	                  field: 'articletitle',
	                  ...
	                  valign: 'middle',
	                	  width: '63%',
	                	  formatter:function(value,row,index){  
	                		  var c = '<a href="/module/share/InsideDetail.do?articleid='+row.articleid+'" >'+row.articletitle+'</a> ';
	                          return c;  
	                      }
...
//	                  field: 'articletitle',
	                  ...
	                  valign: 'middle',
	                	  width: '68%',
	                	  formatter:function(value,row,index){  
	                		  var c = '<a href="InsideDetail.do?articleid='+row.articleid+'" >'+row.articletitle+'</a> ';
	                          return c;  
	                      }
