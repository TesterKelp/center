...
<body class="gray-bg">
	<div class="wrapper wrapper-content animated fadeInRight">
		...
		<table id="t3" data-toggle="table"
									...
									<tr>
<th style="text-align: center; vertical-align: middle;  " data-field="operationid" tabindex="0">
<div class="th-inner ">操作</div><div class="fht-cell" style="width: 50px;"></div></th>
		
<th style="text-align: center; vertical-align: middle; " data-field="operationid" tabindex="0">
<div class="th-inner ">组件</div><div class="fht-cell" style="width: 50px;"></div></th>

<th style="text-align: center; vertical-align: middle;  " data-field="operationid" tabindex="0">
<div class="th-inner ">数据</div><div class="fht-cell" style="width: 50px;"></div></th>

<th style="text-align: center; vertical-align: middle;  " data-field="operationid" tabindex="0">
<div class="th-inner ">检查点</div><div class="fht-cell" style="width: 50px;"></div></th>
...
<c:forEach        items="${caseBody}" var="a"    >
				<tr class="text-c" >
					<td><select class="select"   id="operation" style="width: 100px"    name="operation">
             ...
             <auto:OperationSelect></auto:OperationSelect>
					...
					<td><select class="select" id="widget" style="width: 100px">
					...
					<td><input type="text" name="" id="pdata"   value="${a.pdata}" placeholder="数据" style="width: 150px" class="input-text"></td>
					<td><select class="select"  id="checkpoint"   name="checkpoint" style="width: 100px">
