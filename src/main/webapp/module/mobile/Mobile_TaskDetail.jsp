...
<th style="text-align: center; vertical-align: middle; width: 10%; " data-field="operationid" tabindex="0">
<div class="th-inner "></div><div class="fht-cell" style="width: 177px;">用例ID</div></th>
...
<tr data-index="4">
<td style="text-align: center; vertical-align: middle; width: 10%; "><input type="checkbox" value="${a.caseid}" id="caseid" name="caseid"></td>
<td style="text-align: left; vertical-align: middle; width: 10%; ">${a.caseid}</td>
<td style="text-align: center; vertical-align: middle; width: 10%; ">${a.casename}</td>
...
function addCaseToTask(){
	...
	var taskid = document.getElementById("taskid").value ;
		$.ajax({
			type : "POST",
			url : "/systemtest/AddCaseToTask.do",
			data: {projectid:projectid ,moduleid:moduleid ,taskid:taskid},
			async : false,
			dataType : "text",
			success : function(data) {
				alert(data);
