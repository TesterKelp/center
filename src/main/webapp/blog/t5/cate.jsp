...
<script src="/blogt5/js/jquery.min.js"></script>
<script src="/blogt5/js/skel.min.js"></script>
<script src="/blogt5/js/skel-panels.min.js"></script>
<script src="/blogt5/js/init.js"></script>
			...
			<div class="row">
				...
				<div id="content" class="8u skel-cell-important">
					<c:forEach items="${cl}" var="p">
						...
						<section> <header>
						<span class="byline"><a
							href="/blog/${member.userid}/${p.blogcateid}/b_${p.articleid}.do">${p.articletitle} </a></span> </header>

						<hr style="height: 1px; border: none; margin-top: 1px; border-top: 1px solid #787460;" />
						<div class="clr"></div>
						</section>
					</c:forEach>
				...
				<div id="sidebar" class="4u">
					...
					<ul id="pagelist">
						...
						<c:forEach items="${ltt}" var="p">
							<li><a
								href="/blog/${member.userid}/${p.blogcateid}/b_${p.articleid}.do"><span
									id="com"></span><span class="lbt">${p.articletitle}</span><span
									class="ldt">${p.creattime}</span></a></li>
						</c:forEach>
					</ul>
					</section>
				</div>
