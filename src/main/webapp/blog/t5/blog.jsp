...
<head>
<title>${member.username}博客_ ${article.articletitle}</title>
<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="" />
<meta name="keywords" content="" />

<!--[if lte IE 8]><script src="/blog/t5/js/html5shiv.js"></script><![endif]-->
<script src="/blog/t5/js/jquery.min.js"></script>
<script src="/blog/t5/js/skel.min.js"></script>
<script src="/blog/t5/js/skel-panels.min.js"></script>
<script src="/blog/t5/js/init.js"></script>
		...
		<div class="container">
			<div class="row">
				...
				<div id="content" class="12u skel-cell-important">
					<section> <header>
					<h3 align="center" style="font-size: 25px"> ${article.articletitle}</h3>
					<hr
				...
				<div id="sidebar" class="4u">
					...
					<ul class="style">
						<c:forEach items="${ltt}" var="p">
							<li><a
								href="/blog/${member.userid}/${p.blogcateid}/b_${p.articleid}.do"
								title="${p.articletitle}">${p.articletitle}</li>
						</c:forEach>
					</ul>
					</section>
				</div>
...
//    			alert(data);
    			if(data=="ok"){
    				 location.reload() ;
    				//window.location.href="/blog/"+userid+"/33/b_"+articleid+".do"; 
