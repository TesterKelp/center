...
<div style="width:550px ;margin:0 auto;padding:10px;margin-top:30px;">

<div style="float:left;width:530px;height:100px;line-height:35px;margin-right:5px;border-bottom:1px solid #00a0e9;"> 
手机号码吉凶<Br>
<input type="text" id="telephone"  class="select"  placeholder="请输入手机号码"    style="margin-top:10px;width:180px;" />
<button type="button"  onclick="telephone()"  class="button" style="width:150px;height:33px;">查询</button>
</div>
