...
<div style="float:left;padding-left:10px;width:530px;height:100px;line-height:35px;"> 
电话号码吉凶（无需区号）<Br>
<input type="text" id="tel"  class="inputt" placeholder="请输入电话号码"    style="margin-top:10px;width:150px;height:30px;" />
<button type="button"  onclick="tel()"  class="button" style="width:150px;margin-top:0px;height:33px;">查询</button>
</div>
