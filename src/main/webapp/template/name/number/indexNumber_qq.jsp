...
QQ号码吉凶<Br>
<input type="text" id="qq"  class="select" placeholder="请输入QQ号码"    style="margin-top:10px;width:150px;height:30px;" />
<button type="button"  onclick="qq()"  class="button"  style="width:150px;height:33px;">查询</button>
</div>
