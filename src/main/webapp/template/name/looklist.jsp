...
<html>
<head>
<title>${article.articletitle}_${special.catename}_${m.item_name}</title>
<meta charset="utf-8">
				...
				<div class="ibox">
					<div class="ibox-content"   style="min-height: 800px;" >
						...
						<div class="pull-right">
							<a href='/blog/Blog.do?userid=${member.userid}'>${member.username} </a>
						...
						<div class="col-lg-12">
						<div class="col-lg-10"  id="col-lg-9" style="border-right:1px dashed #A9A9A9 ;border-left:1px dashed #A9A9A9 ;word-wrap: break-word;word-break: break-all;min-height:800px" >
						
						
						<c:forEach items="${dt}" var="a" varStatus="status">  
						${a.title}  <hr>
						${a.dsc}  <hr>
						${a.time}  <hr>
						${a.more}  <hr>
