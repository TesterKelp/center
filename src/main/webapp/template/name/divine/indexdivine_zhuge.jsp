...
<div style="float:left;width:180px;height:auto"><img src="${divin.pic}"  width="240px;" ></div>  
 ...
 <div align="center"> 
  ...
  <div id="rs" style="height:30px;"></div>
   ...
   <input type="text" name="name1" id="word"       placeholder="请输入三个简体汉字"   style="width:150px;font-size: 10px;height:22px"  value="" >
   <button type="button"  onclick="zhuge('${divin.id}')"   style="width:160px;font-size: 10px;height:22px;margin-top:10px;">开测算</button>
