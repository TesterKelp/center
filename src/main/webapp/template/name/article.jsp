		...
		<div class="row">
				...
				<div class="ibox">
					<div class="ibox-content"   style="min-height: 800px;" >				
						...
						<div class="col-lg-8"  id="col-lg-9" style="border-right:1px dashed #A9A9A9 ;border-left:1px dashed #A9A9A9 ;word-wrap: break-word;word-break: break-all;min-height:800px" >
						<div class="text-center" style=""><h2> <b>${article.articletitle} </b></h2></div>
