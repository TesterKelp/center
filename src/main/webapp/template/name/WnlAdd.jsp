...
function changeCld() {
	...
	drawCld(y,m);	
	switch (m){
	case 0 : ST.innerHTML = '【 '+STA[0]+kgm+STA[1]+' 】'; a20.innerHTML = '【 '+STA[0]+kgm+STA[1]+' 】';   $("#p8").val('【 '+STA[0]+kgm+STA[1]+' 】')  ;
	break;
	case 1 : ST.innerHTML = '【 '+STA[1]+kgm+STA[2]+' 】'; a20.innerHTML = '【 '+STA[1]+kgm+STA[2]+' 】';  $("#p8").val('【 '+STA[1]+kgm+STA[2]+' 】');
	break;
	case 2 : ST.innerHTML = '【 '+STA[2]+kgm+STA[3]+' 】'; a20.innerHTML = '【 '+STA[2]+kgm+STA[3]+' 】'; $("#p8").val('【 '+STA[2]+kgm+STA[3]+' 】');
	break;
	case 3 : ST.innerHTML = '【 '+STA[3]+kgm+STA[4]+' 】'; a20.innerHTML = '【 '+STA[3]+kgm+STA[4]+' 】' ; $("#p8").val('【 '+STA[3]+kgm+STA[4]+' 】') ;
	break;
	case 4 : ST.innerHTML = '【 '+STA[4]+kgm+STA[5]+' 】'; a20.innerHTML = '【 '+STA[4]+kgm+STA[5]+' 】'; $("#p8").val('【 '+STA[4]+kgm+STA[5]+' 】');
	break;
	case 5 : ST.innerHTML = '【 '+STA[5]+kgm+STA[6]+' 】'; a20.innerHTML = '【 '+STA[5]+kgm+STA[6]+' 】'; $("#p8").val('【 '+STA[5]+kgm+STA[6]+' 】');
	break;
	case 6 : ST.innerHTML = '【 '+STA[6]+kgm+STA[7]+' 】'; a20.innerHTML = '【 '+STA[6]+kgm+STA[7]+' 】';  $("#p8").val('【 '+STA[6]+kgm+STA[7]+' 】');
	break;
	case 7 : ST.innerHTML = '【 '+STA[7]+kgm+STA[8]+' 】'; a20.innerHTML = '【 '+STA[7]+kgm+STA[8]+' 】'; $("#p8").val('【 '+STA[7]+kgm+STA[8]+' 】');
	break;
	case 8 : ST.innerHTML = '【 '+STA[8]+kgm+STA[9]+' 】';  a20.innerHTML = '【 '+STA[8]+kgm+STA[9]+' 】'; $("#p8").val('【 '+STA[8]+kgm+STA[9]+' 】'); 
	break;
	case 9 : ST.innerHTML = '【 '+STA[9]+kgm+STA[10]+' 】'; a20.innerHTML = '【 '+STA[9]+kgm+STA[10]+' 】'; $("#p8").val('【 '+STA[9]+kgm+STA[10]+' 】');
	break;
	case 10 : ST.innerHTML = '【 '+STA[10]+kgm+STA[11]+' 】'; a20.innerHTML = '【 '+STA[10]+kgm+STA[11]+' 】';  $("#p8").val('【 '+STA[10]+kgm+STA[11]+' 】');
	break;
	default : ST.innerHTML = '【 '+STA[11]+kgm+STA[0]+' 】';  a20.innerHTML = '【 '+STA[11]+kgm+STA[0]+' 】';  $("#p8").val('【 '+STA[11]+kgm+STA[0]+' 】');
	}
}
...
function mOvr(v) {
	...
	if(sObj.innerHTML!='') {
		...
		dayy = cld[d].sYear +""+cld[d].sMonth+""+cld[d].sDay ;
		
		if(cld[d].sMonth<10){
			dayy = cld[d].sYear +"0"+cld[d].sMonth ;
		}else{
			dayy = cld[d].sYear +""+cld[d].sMonth
		}
		
		if(cld[d].sDay<10){
			dayy =dayy+"0"+cld[d].sDay  ;	
		}else{
			dayy =dayy+""+cld[d].sDay  ;
		}
	...
	//	alert(dayy);
		...
		for(i=0;i<12;i++){
			...
			if(Zhi[i]==cld[d].cDay.substring(1,2)){
				rObj.style.background = '#dddddd';
				 $("#w3").val(i); 
			}
				
			if(Zhi[i]==RCT) {
				rObj.style.background = '#fc9';
			//	 $("#w3").val(i); alert(i);
			}
		...
		$("#p4").val(Lunard+'&nbsp;'+zhou);
		$("#p5").val(cYMD);
	var r =	cld[d].solarFestival +"-"+  cld[d].lunarFestival +"-"+  cld[d].solarTerms
...
<!--
<div style="float:right;width:20%;margin:40px;border:1px solid #00a0e9;"> 
说明：<br>
...
<div style="padding-left:100px;float:left;width:25%;border:1px solid #00a0e9;">
...
<div style="margin-left:100px;float:left;width:60% ;border:1px solid #00a0e9;">
...
<input type="text" id="p1"   siz="15" style="margin-bottom: 0px; margin-top: 8px; width:400px">
<input type="text" id="p2"   siz="15" style="margin-bottom: 0px; margin-top: 8px; width:400px">
<input type="text" id="p3"  value="0" siz="15" style="margin-bottom: 0px; margin-top: 8px; width:400px">

<input type="text" id="p4"   siz="15" style="margin-bottom: 0px; margin-top: 8px; width:400px">
<input type="text" id="p5"   siz="15" style="margin-bottom: 0px; margin-top: 8px; width:400px">
<input type="text" id="p6"   siz="15" style="margin-bottom: 0px; margin-top: 8px; width:400px">
<input type="text" id="p7"   siz="15" style="margin-bottom: 0px; margin-top: 8px; width:400px">
<input type="text" id="p8"   siz="15" style="margin-bottom: 0px; margin-top: 8px; width:400px">
<input type="text" id="p9"   siz="15" style="margin-bottom: 0px; margin-top: 8px; width:400px">
