...
.txPiclist li:nth-child(4n-7){margin-left:0;}
	...
	<ul >
		...
		<li>
			...
			<p style="text-align:center">分类:<span><a href="/name/suanming/indexchenggu.do">称骨算命</a></span><span class="time">共100签</span></p>
			</li>
		
		<!--  
			<li>
			<a target="_blank" href="/chouqian/lvzu/" class="img"><img src="/template/name/pic/divine/list/lvzu.jpg" width="207" height="240"></a>
			<div class="title"><a  target="_blank" href="/chouqian/guanyin/">八字算命</a></div>
			<p style="text-align:center">分类:<span><a href="/chouqian/lvzu/">八字算命</a></span><span class="time">共100签</span></p>
			</li>
	<li>
			<a target="_blank" href="/chouqian/guanyin/" class="img"><img src="/template/name/pic/divine/list/guanyin.jpg" width="207" height="240"></a>
			<div class="title"><a  target="_blank" href="/chouqian/guanyin/">本命卦合婚</a></div>
			<p style="text-align:center">分类:<span><a href="/chouqian/guanyin/">本命卦合婚</a></span><span class="time">共100签</span></p>
			</li>
			<li>
			<a target="_blank" href="/chouqian/guandi/" class="img"><img src="/template/name/pic/divine/list/guandi.jpg" width="207" height="240"></a>
			<div class="title"><a  target="_blank" href="/chouqian/guandi/">八字合婚</a></div>
			<p style="text-align:center">分类:<span><a href="/chouqian/guandi/">八字合婚</a></span><span class="time">共100签</span></p>
			</li>
