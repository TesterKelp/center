...
<div style="padding-left:100px;float:left;width:100%;border:1px solid #00a0e9;">
<!--  <c:forEach items="${lst}" var="a"  begin="0"  end="365" step="1" varStatus="v"><div class="ll" > ${a.dayg}  </div></c:forEach>
...
--> 
 ...
 <c:forEach var="i"   begin="2000"  end="2021" step="1" varStatus="v"><div class="ll" > ${i}  </div></c:forEach>
