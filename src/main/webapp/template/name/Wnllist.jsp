...
<Div style="width:21%;float:left;border:1px solid #00a0e9;padding:10px;height:880px;">

<div style="line-height:30px;">一月<hr style="padding-bottom:5px;"></div>
<c:forEach items="${clt}" var="a"   varStatus="v">
<c:if test="${fn:contains(a.dayn,year.concat('01'))}">
<div class="ll" > <a href="/name/${year}/${a.id}/wnldetail.do" >   ${ fn:substring( a.dayn ,6,8)}         </a>  </div>
</c:if>
</c:forEach>

<div style="clear:both"></div> 
<div style="line-height:30px;">二月<hr style="padding-bottom:5px;"></div>
<c:forEach items="${clt}" var="a"   varStatus="v">
<c:if test="${fn:contains(a.dayn,year.concat('02'))}">
<div class="ll" > <a href="/name/${year}/${a.id}/wnldetail.do" >${ fn:substring( a.dayn ,6,8)}</a>  </div>
</c:if>
</c:forEach>
...
三月<hr>
<c:forEach items="${clt}" var="a"   varStatus="v">
<c:if test="${fn:contains(a.dayn,year.concat('03'))}">
<div class="ll" > <a href="/name/${year}/${a.id}/wnldetail.do" >${ fn:substring( a.dayn ,6,8)}</a>  </div>
</c:if>
</c:forEach>
 ...
 <div  style="padding-top:15px;margin-left:15px;margin-right: 5px;width:620px ;height:880px;border:1px solid #00a0e9;float:left;padding-bottom:35px;padding:10px;">
 ...
 四月<hr>
<c:forEach items="${clt}" var="a"   varStatus="v">
<c:if test="${fn:contains(a.dayn,year.concat('04'))}">
<div class="ll" > <a href="/name/${year}/${a.id}/wnldetail.do" >${ fn:substring( a.dayn ,6,8)}</a>  </div>
</c:if>
</c:forEach>
<div style="clear:both"></div> 
 五月<hr>
<c:forEach items="${clt}" var="a"   varStatus="v">
<c:if test="${fn:contains(a.dayn,year.concat('05'))}">
<div class="ll" > <a href="/name/${year}/${a.id}/wnldetail.do" >${ fn:substring( a.dayn ,6,8)}</a>  </div>
</c:if>
</c:forEach>
...
六月<hr>
<c:forEach items="${clt}" var="a"   varStatus="v">
<c:if test="${fn:contains(a.dayn,year.concat('06'))}">
<div class="ll" > <a href="/name/${year}/${a.id}/wnldetail.do" >${ fn:substring( a.dayn ,6,8)}</a>  </div>
</c:if>
</c:forEach>
<div style="clear:both"></div> 
七月<hr>  
<c:forEach items="${clt}" var="a"   varStatus="v">
<c:if test="${fn:contains(a.dayn,year.concat('07'))}">
<div class="ll" > <a href="/name/${year}/${a.id}/wnldetail.do" >${ fn:substring( a.dayn ,6,8)}</a>  </div>
</c:if>
</c:forEach>
...
八月<hr>
<c:forEach items="${clt}" var="a"   varStatus="v">
<c:if test="${fn:contains(a.dayn,year.concat('08'))}">
<div class="ll" > <a href="/name/${year}/${a.id}/wnldetail.do" >${ fn:substring( a.dayn ,6,8)}</a>  </div>
</c:if>
</c:forEach>
<div style="clear:both"></div> 
九月<hr>
<c:forEach items="${clt}" var="a"   varStatus="v">
<c:if test="${fn:contains(a.dayn,year.concat('09'))}">
<div class="ll" > <a href="/name/${year}/${a.id}/wnldetail.do" >${ fn:substring( a.dayn ,6,8)}</a>  </div>
</c:if>
</c:forEach>  
...
<!--
<c:forEach items="${clt}" var="a"   varStatus="v">
<div class="ll" > <a href="/name/${year}/${a.id}/wnldetail.do" >${a.dayn}</a>  </div>
</c:forEach>
  -->
 ...
 <div  style="width:21% ;height:880px;border:1px solid #00a0e9;float:right;padding-top:20px;margin-bottom:30px;padding:10px;">    

  十月<hr>
<c:forEach items="${clt}" var="a"   varStatus="v">
<c:if test="${fn:contains(a.dayn,year.concat('10'))}">
<div class="ll" > <a href="/name/${year}/${a.id}/wnldetail.do" >${ fn:substring( a.dayn ,6,8)}</a>  </div>
</c:if>
</c:forEach>
...
十一月<hr>
<c:forEach items="${clt}" var="a"   varStatus="v">
<c:if test="${fn:contains(a.dayn,year.concat('11'))}">
<div class="ll" > <a href="/name/${year}/${a.id}/wnldetail.do" >${ fn:substring( a.dayn ,6,8)}</a>  </div>
</c:if>
</c:forEach>
...
十二月<hr>
<c:forEach items="${clt}" var="a"   varStatus="v">
<c:if test="${fn:contains(a.dayn,year.concat('12'))}">
<div class="ll" > <a href="/name/${year}/${a.id}/wnldetail.do" >${ fn:substring( a.dayn ,6,8)}</a>  </div>
</c:if>
</c:forEach>  
