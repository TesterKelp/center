...
<div class="col-lg-8" style="min-height: 900px;border-right:1px dashed #A9A9A9 ; ">
...
<div class="col-lg-4" style="min-height: 800px; ">
	<br>
				
							<a href='/blog/Blog.do?userid=${article.userid}'>分  享  者：${member.username} </a>  <Br>
							<a href='/blog/Blog.do?userid=${article.userid}'>分享时间：${article.creattime} </a> <Br>
