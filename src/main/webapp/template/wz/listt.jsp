...
<style type="text/css">
	...
	<div class="row" >
		...
		<div class="col-lg-9"  style="border-right:1px dashed #A9A9A9 ; ">	
...
<div class="left702">
  ...
  <a href="/${item}/${cat}/${a.catedirectory}/article_${a.articleid}.${kuo}"  style="font-family: 'open sans', 'Helvetica Neue', Helvetica, Arial, sans-serif;
