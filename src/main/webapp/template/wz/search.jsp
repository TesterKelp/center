...
.box a {
	...
	<div class="row" >
			<div class="ibox-content"    style="min-height: 850px; width:1300px;margin:0 auto;" >
  ...
  <c:if test="${a.pdir != m.item_directorie}">    
  <li><span>${a.creattime}</span><a href="/${m.item_directorie}/${a.pdir}/${a.catedirectory}/article_${a.articleid}.${kuo}">${a.articletitle }</a></li>
  </c:if>
 <c:if test="${a.pdir == m.item_directorie}">
  <li><span>${a.creattime}</span><a href="/${m.item_directorie}/${a.catedirectory}/article_${a.articleid}.${kuo}">${a.articletitle }</a></li>
 </c:if>		
</c:forEach>           
