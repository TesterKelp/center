...
<body class="gray-bg" >
	...
	<div class="row" >		
			...
			<div class="ibox-content"  style="min-height: 800px; width:1500px;margin:0 auto;" >
...
ul.imglist li{ float:left; padding:4px 8px; width:18.5%;margin-left:10px;margin-right:10px;}
/**ul.imglist li{ float:left; padding:4px 8px; width:260px;margin-left:10px;margin-right:10px;} 
   ul.imglist li img{ display:block; width:240px; height:165px}   **/
ul.imglist li img{ display:block; width:100%; height:175px} 
ul.imglist li span{ display:block; width:100%; height:50px; line-height:30px; background:#F6F6F6} 
</style>
       <ul class="imglist"> 
  ...
  <a href="/${item}/${cate}/${a.catedirectory}/article_${a.articleid}.${kuo}"  style="font-family: 'open sans', 'Helvetica Neue', Helvetica, Arial, sans-serif;
    font-size: 16px;line-height: 24px;" target="_blank">
    <img src="${a.picaddress}" />
    <span style="text-align:center">${a.articletitle }</span>
    </a>
  </c:if>
