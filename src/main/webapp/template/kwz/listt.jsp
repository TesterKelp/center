...
<title>${site.sitename}_${m.item_name}_${c.catename}_${c.pdir}</title>
...
<body class="gray-bg" >
	...
	<div class="row" >		
            ...
            <div class="RightSidebar">
                  <div class="Current">
                        <dl>你现在的位置:  <a href="/index.${kuo}">网站首页</a> >  <c:if test="${site.singleitem =='100'}"> <a href="/${item}/portal.${kuo}">频道首页</a> > </c:if> 
